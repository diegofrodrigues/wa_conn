...
class WhatsAppAccount(models.Model):
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            ...
            if 'name' in vals and 'company_ids' in vals:
                existing_account = self.search([
                    ('name', '=', vals['name']),
                    ('company_ids', 'in', vals['company_ids'])
                ])
                if existing_account:
                    raise ValueError(_("A WhatsApp account with this name already exists for the selected companies."))
        ...
        accounts = super(WhatsAppAccount, self).create(vals_list)
